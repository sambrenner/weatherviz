THREE.EdgeDetectionShader = {
  ...
  fragmentShader: [
    ...
    "bool isCloud(in vec2 coords) {",
      "if(get_pixel(coords,0.0,0.0).a == 0.0) {",
        "return false;",
      "} else {",
        "return true;",
      "}",
    ...
    "void main() {",
      "vec4 color = isEdge(vUv) ? vec4(0.0,0.0,0.0,1.0) : (isCloud(vUv) ? vec4(1.0,1.0,1.0,1.0) : vec4(0.0,0.0,0.0,0.0));",
      "gl_FragColor = color;",
    "}"
